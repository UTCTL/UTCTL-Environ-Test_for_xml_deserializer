...
public class LoadXML : MonoBehaviour {
	...
	void Start()
	{
		Debug.Log ("Parsing name mappings...");
		NameMap nameMapping = NameMap.DeserializeXml (Path.Combine (Application.dataPath, "mappings.xml"));
		Debug.Log ("Finished parsing name mappings.");

		ActionNodeContainer nodeCollection = Container.DeserializeXml(Path.Combine(Application.dataPath, "action_nodes.xml"));
